<nav class="bg-[#056594] shadow-md fixed top-0 left-0 w-full z-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-50">
        <div class="flex justify-start items-center h-16"> <!-- Changed justify-between to justify-start -->
            ...
            <!-- Nav Links -->
            <div class="hidden md:flex space-x-20  ml-52">
                <!-- Reduced space-x-6 to space-x-4 and added ml-4 to add a little margin -->
                ...
                @auth
                    <div class="relative" id="profileDropdownWrapper">
                        <button id="profileDropdownBtn" type="button" class="flex items-center focus:outline-none">
                            ...
                            <span
                                class="ml-2 text-white font-semibold hidden md:inline">{{ Auth::user()->customer?->first_name ?? 'User' }}</span>
...
<div id="loginModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    ...
    <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6 relative">
        ...
        <p class="text-center text-sm text-gray-600 mt-4">
            No account yet?
            <a href="#" class="text-[#056594] font-medium hover:underline" onclick="openSignUpFromLogin(event)">Register
                Now</a>
        </p>
    </div>
</div>
...
<div id="signUpModal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden flex items-center justify-center">
    <div class="relative bg-white rounded-lg shadow-lg w-full max-w-md p-8">
        ...
        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
            ...
            <button type="submit" class="w-full bg-[#056594] text-white py-2 rounded hover:bg-[#04547C] transition">Sign
                Up</button>
        </form>
        <!-- Back to Login Link -->
        <p class="text-center text-sm text-gray-600 mt-4">
            Already have an account?
            <a href="#" onclick="backToLogin(); return false;" class="text-[#056594] font-medium hover:underline">Back
                to Login</a>
        </p>
    </div>
</div>
