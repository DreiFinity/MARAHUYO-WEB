...
<body class="bg-gray-100 ">
    ...
    <section class="relative h-screen bg-cover bg-center md:mt-20"
        style="background-image: url('images/hero-image.jpg');">
        <div class="absolute inset-0 bg-black bg-opacity-40"></div>
        <div
            class="relative z-10 max-w-6xl mx-auto px-4 text-center text-white flex flex-col items-center justify-center h-full space-y-6">
            <!-- Headline -->
            ...
            <p class="max-w-2xl text-base md:text-lg font-light">
                Welcome to Marahuyo Hotel, your serene escape by the sea. Nestled along a pristine beachfront,
                Marahuyo—meaning "to enchant or bewitch"—is where nature’s beauty meets warm Filipino hospitality.
            </p>
            ...
            <form action="{{ route('rooms.available') }}" method="GET" id="bookingForm">
                <div
                    class="grid grid-cols-1 md:grid-cols-5 gap-10 mt-6 text-gray-900 border border-white rounded-md bg-opacity-10 p-4 bg-gray-800 relative z-0">
                    ...
                    <div class="flex flex-col items-start ">
                        ...
                        <input type="date" id="checkinDate" name="checkin"
                            class="custom-date border border-gray-300 rounded-md px-3 py-2 bg-white shadow-md text-gray-900 w-full"
                            required />
                    </div>
                    ...
                    <div class="  flex flex-col items-start md:col-span-2 mt-2">
                        ...
                        <!-- Modal -->
                        <div id="guestModal"
                            class="absolute mt-2 p-4 bg-white rounded-md shadow-lg hidden z-20 text-sm w-60">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <div class="flex items-center space-x-2">
                                    <button type="button" onclick="adjustCount('guests', -1)"
                                        class="px-2 py-1 bg-gray-200 rounded hover:bg-gray-300">−</button>
    ...
    <section class="mt-32 mx-5 md:mx-20   gap-5">
        ...
        <div class="dm-sans flex flex-col gap-12 " id="room-sample">
            <div class="flex flex-col md:flex-row gap-8 mb-20 items-center md:items-start">
                ...
                <div class="w-full md:w-1/2 flex justify-center md:justify-start mb-6 md:mb-0">
                    <img class="w-full max-w-xs md:max-w-full h-64 md:h-100 object-cover transition-all duration-300 transform shadow-md hover:shadow-lg hover:scale-110 rounded-lg"
                        src="images/hero2.png" alt="Classic Room">
                </div>
                <!-- Text -->
                <div class="w-full md:w-1/2 flex flex-col justify-center md:justify-center px-2 md:ml-24 h-full">
                    <div class="mt-4 md:mt-28 flex flex-col justify-center h-full">
                        ...
                        <p class="text-base md:text-lg mt-4 mb-8 md:mb-32 text-center md:text-left">
                            Experience the spellbinding embrace of our <span><br class="hidden md:block">cozy
                                accommodations-your sanctuary by the <span><br class="hidden md:block">sea, where sunlit
                                    rooms and ocean whispers <span></span> <br class="hidden md:block">create a haven of
                                    tranquility.</span></span>
                        </p>
                        <div class="flex justify-center md:justify-start">
                            <a href="/rooms" class="relative inline-block w-full md:w-auto">
                                <button
                                    class="w-full md:w-auto bg-[#056594] text-white py-3 px-6 rounded-lg font-semibold hover:bg-[#004364] transition-colors duration-200">Book
                                    Now</button>
                            </a>
                        </div>
                    </div>
        ...
        <div class="dm-sans flex flex-col gap-12" id="about">
            ...
            <div class="flex flex-col md:flex-row gap-8 mb-20">
                ...
                <div class="md:w-1/2">
                    <img class="hidden md:block w-full transition-all duration-300 transform shadow-md hover:shadow-lg hover:scale-110 rounded-lg"
                        src="/images/deluxe.png" alt="">
                </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
                ...
                <div class="bg-gray-100 rounded-2xl p-8 hover:shadow-lg transition-shadow duration-300">
                    <div class="flex items-center mb-6">
                        <img src="images/testimonials 1.png" alt="Mariz E. Adlaw"
                    ...
                    <p class="text-gray-700 leading-relaxed">
                        "The view from our room was absolutely breathtaking! Waking up to the sound of the waves was
                        pure bliss. Marahuyo is truly a hidden gem."
                    </p>
                </div>
                ...
                <div class="bg-gray-100 rounded-2xl p-8 hover:shadow-lg transition-shadow duration-300">
                    <div class="flex items-center mb-6">
                        <img src="images/testimonials 2.png" alt="Bernadette Hilario"
                            class="w-12 h-12 rounded-full mr-4 object-cover">
                        <div>
                    ...
                    <p class="text-gray-700 leading-relaxed">
                        "From the warm welcome to the beachfront breakfast, everything was perfect. We felt so relaxed
                        and well taken care of. Can't wait to come back!"
                    </p>
                </div>

                <!-- Testimonial 3 -->
                <div
                    class="bg-gray-100 rounded-2xl p-8 hover:shadow-lg transition-shadow duration-300 md:col-span-2 lg:col-span-1">
                    <div class="flex items-center mb-6">
                        <img src="images/testimonials 3.png" alt="Ivan Sampan"
                            class="w-12 h-12 rounded-full mr-4 object-cover">
                        <div>
                    ...
                    <p class="text-gray-700 leading-relaxed">
                        "Marahuyo Hotel exceeded all our expectations. The staff was incredibly friendly, and the
                        location is unbeatable. A peaceful paradise by the sea."
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="container mx-auto px-4 py-16">
        <div class="text-center mb-12">
            ...
            <p class="text-lg text-gray-700 max-w-4xl mx-auto leading-relaxed">
                Whether you're a frequent business traveler or a luxury explorer, our tiered membership plans offer
                unbeatable benefits tailored to your lifestyle.
            </p>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-16">
            <!-- Silver Member -->
            <div
                class="bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 p-8 border border-gray-200">
                <div class="flex items-center mb-6">
                ...
                <button onclick="if(requireLoginForSubscription()) openRegistrationModal('Silver', 560)"
                    class="w-full bg-[#056594] text-white py-3 px-6 rounded-lg font-semibold hover:bg-[#004364] transition-colors duration-200">
                    Join
                </button>
            </div>
            ...
            <!-- Gold Member -->
            <div
                class="bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 p-8 border-2 border-amber-200 relative">
                <div class="absolute -top-4 left-1/2 transform -translate-x-1/2">
                    <span
                        class="bg-amber-400 text-amber-900 px-4 py-1 rounded-full text-sm font-semibold">POPULAR</span>
                </div>
                <div class="flex items-center mb-6">
                ...
                <button onclick="if(requireLoginForSubscription()) openRegistrationModal('Gold', 1400)" [=p-]
                    class="w-full bg-marahuyo-gold text-white py-3 px-6 rounded-lg font-semibold hover:bg-amber-600 transition-colors duration-200">
                    Join
                </button>
            </div>
            ...
            <!-- Platinum Member -->
            <div
                class="bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 p-8 border border-gray-300">
                <div class="flex items-center mb-6">
                ...
                <button onclick="if(requireLoginForSubscription()) openRegistrationModal('Platinum', 3360)"
                    class="w-full bg-[#056594] text-white py-3 px-6 rounded-lg font-semibold hover:bg-[#004364] transition-colors duration-200">
                    Join
                </button>
            </div>
                    ...
                    <form id="registrationForm" class="space-y-6">
                        ...
                        <div class="border-t pt-6">
                            ...
                            <div class="grid md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Purpose of
                                        Travel</label>
                            ...
                            <div class="mt-4">
                                ...
                                <div class="grid md:grid-cols-2 gap-2">
                                    <label class="flex items-center">
                                        <input type="checkbox" name="preferences" value="oceanView"
                                            class="mr-2 text-blue-600">
                                        Ocean view rooms
                                    </label>
                                    <label class="flex items-center">
                                        <input type="checkbox" name="preferences" value="spa"
                                            class="mr-2 text-blue-600">
                                        Spa services
                                    </label>
                                    <label class="flex items-center">
                                        <input type="checkbox" name="preferences" value="dining"
                                            class="mr-2 text-blue-600">
                                        Fine dining
                                    </label>
                                    <label class="flex items-center">
                                        <input type="checkbox" name="preferences" value="fitness"
                                            class="mr-2 text-blue-600">
                                        Fitness facilities
                                    </label>
                                    <label class="flex items-center">
                                        <input type="checkbox" name="preferences" value="activities"
                                            class="mr-2 text-blue-600">
                                        Water activities
                                    </label>
                                    <label class="flex items-center">
                        ...
                        <div class="border-t pt-6">
                            ...
                            <div class="grid grid-cols-2 gap-4 mt-4">
                                <div>
                                    ...
                                    <input type="text" name="expiryDate" required placeholder="MM/YY" maxlength="5"
                                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                </div>
                                <div>
                        ...
                        <div class="border-t pt-6">
                            <div class="flex items-start">
                                ...
                                <label class="text-sm text-gray-700">
                                    I agree to the <a href="#" class="text-blue-600 hover:underline">Terms of
                                        ...
                                        Policy</a>. I understand that my membership will auto-renew monthly and I can
                                    cancel at any time.
                                </label>
                            </div>
                            <div class="flex items-start mt-3">
                                ...
                                <label class="text-sm text-gray-700">
                                    I would like to receive newsletters and promotional offers from Marahuyo Hotel &
                                    Resort.
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 pt-6">
                            ...
                            <button type="submit"
                                class="flex-1 px-6 py-3 bg-[#056594] text-white rounded-lg font-medium hover:bg-blue-700 transition-colors">
        ...
        <div id="successModal"
            ...
            <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 text-center">
                ...
                <p class="text-gray-600 mb-6">Your membership registration has been completed successfully. You'll
                    receive a confirmation email shortly with your membership details.</p>
    ...
    <div id="loginModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        ...
        <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6 relative">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-4 px-4 ">
                ...
                <button type="submit" class="w-full bg-[#056594] text-white py-2 rounded hover:bg-[#04547C] transition">
                    Login
                </button>
            </form>
            <!-- Register Link -->
            <p class="text-center text-sm text-gray-600 mt-4">
                No account yet?
                <a href="#" class="text-[#056594] font-medium hover:underline"
                    onclick="openSignUpFromLogin(event)">Register Now</a>
            </p>
        </div>
    </div>
        ...
        <div class="relative bg-white rounded-lg shadow-lg w-full max-w-md p-8">
            ...
            <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input id="signup-profile-picture" name="profile_picture" type="file" accept="image/*"
                        class="w-full border border-gray-300 rounded px-4 py-2">
                </div>
                <button type="submit"
                    class="w-full bg-[#056594] text-white py-2 rounded hover:bg-[#04547C] transition">Sign Up</button>
            </form>
            <!-- Back to Login Link -->
            <p class="text-center text-sm text-gray-600 mt-4">
                Already have an account?
                <a href="#" onclick="backToLogin(); return false;"
                    class="text-[#056594] font-medium hover:underline">Back to Login</a>
            </p>
        </div>
    </div>
    <script>
